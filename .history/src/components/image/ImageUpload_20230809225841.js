...
const ImageUpload = (props) => {
  ...
  return (
    <label
      className={`cursor-pointer flex items-center justify-center bg-[var(--gray-200)] border border-dashed w-full min-h-[200px] max-h-[240px] rounded-lg ${className} relative overflow-hidden`}
    >
      <input
        type="file"
        name={name}
