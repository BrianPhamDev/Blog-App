...
const ImageUpload = (props) => {
  ...
  return (
    <label
      className={`cursor-pointer flex items-center justify-center bg-gray-100 border border-dashed w-full min-h-[140px] rounded-lg ${className} relative overflow-hidden`}
    >
      <input
        type="file"
        name={name}
