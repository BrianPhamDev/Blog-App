  ...
  return (
    <div className="dashboard-header-wrapper bg-white p-5 border-b border-b-black flex gap-5 justify-end">
      ...
      <div className="dashboard-header-avatar h-[52px] w-[52px]">
        <img
          src="https://images.unsplash.com/photo-1633533451997-8b6079082e3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1331&q=80"
          alt="guys-smilling"
