        ...
        <main className="post-wrapper mt-[32px]">
          ...
          <div className="post-grid">
            ...
            <div className="post-side-content">
              ...
              Recusandae praesentium, culpa vel similique vitae at. Tempora
              reiciendis dolorum, iste qui, voluptatem veritatis molestias at
              rem voluptatibus, consequatur adipisci alias dolorem?
            </div>
          </div>
        </main>
      </Layout>
